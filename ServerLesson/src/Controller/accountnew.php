...
<?php
    ...
    if (! $displayAccountUserName){
        ...
        // Dans l'instruction suivante, on travaille avec la pr̩paration de SQL statement qui permet
        // d'escaper les variables re̤ues de l'utilisateur => cela permet d'̩viter les attaques
